      ...
      <div className="relative pt-24 pb-16 bg-gradient-to-br from-ivory to-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
          ...
          <div className="text-center">
            ...
            {/* Quick Stats */}
            <div className="inline-flex flex-wrap items-center justify-center gap-3 sm:gap-6 px-4 sm:px-6 py-3 bg-white/50 backdrop-blur-sm rounded-2xl border border-red-burgundy/10 max-w-full">
              <div className="flex items-center gap-2 whitespace-nowrap">
                <MapPinIcon className="h-4 w-4 text-red-burgundy flex-shrink-0" />
                <span className="text-sm text-subtext">{creator.homeCity}</span>
              </div>
              <div className="flex items-center gap-2 whitespace-nowrap">
                <UserIcon className="h-4 w-4 text-red-burgundy flex-shrink-0" />
              ...
              {creator.instagramHandle && (
                <a 
                  ...
                  className="flex items-center gap-2 hover:text-red-burgundy transition-colors whitespace-nowrap"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="text-pink-500 flex-shrink-0" viewBox="0 0 16 16">
